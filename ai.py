...
При получении сообщения исправь ошибки, опечатки, жаргонизмы, сокращения и определи тип сообщения:
...
- task: /add
- time: время задачи в формате YYYY-MM-DD HH:MM, если  указано время, иначе пустое значение.
