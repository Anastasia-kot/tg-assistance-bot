...
MSG_START_NEED_AUTH = (
    "Этот бот публикует ваши фото в сторис Telegram.\n\n"
    "Подключите аккаунт один раз: пришлите номер телефона в международном формате, например +79001234567."
)
...
MSG_STATUS_NEED = "Аккаунт ещё не подключён. Нажмите /login или пришлите номер телефона."
MSG_LOGOUT = "Сессия удалена. Чтобы публиковать сторис, подключите аккаунт снова: пришлите номер или /login."
...
MSG_NEED_AUTH_FOR_PHOTO = "Сначала подключите аккаунт. Пришлите номер телефона в формате +7…"
